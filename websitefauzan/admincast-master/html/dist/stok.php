...
<body class="fixed-navbar">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                    $ambilsemuadatastokbahan = mysqli_query($conn, "select * from stokbahan");
                                    $i =1;
                                    while($data=mysqli_fetch_array($ambilsemuadatastokbahan)){
                                        $namabahan = $data['namabahan'];
                                        $jumlahstok = $data['jumlahstok'];
                                        $ids = $data['idstokbahan'];
                                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$jumlahstok;?></td>
                                        <td>
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edit<?=$ids;?>"><i class="fa fa-edit"></i>
                                                Edit
                                            </button>
                                            <button type="button" data-id="<?=$ids;?>" class="btn btn-danger btn-hapus" data-toggle="modal" data-target="#delete<?=$ids;?>"><i class="fa fa-trash"></i>
                                                Delete
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    <div class="modal fade" id="edit<?=$ids;?>">
                                        ...
                                        <h4 class="modal-title">Edit Data Stok Bahan</h4>
                                        ...
                                        <div class="form-group"><label>Jumlah Stok</label><input type="number" name="jumlahstok" value="<?=$jumlahstok;?>" class="form-control" required></div>
                                        <br>
                                        <input type="hidden" name="ids" value="<?=$ids;?>">
                                        <button type="submit" class="btn btn-primary" name="updatestokbahan">Submit</button>
                                        </div>
                                        </form>
                                        </div>
                                        </div>
    ...
    <div class="modal fade" id="myModalTambah">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Tambah Stok Bahan</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <div class="modal-body">
          ...
          <div class="form-group"><label>Jumlah Stok:</label><input type="number" name="jumlahstok" placeholder="Masukkan Jumlah Stok" class="form-control" required></div>
          <br>
          <button type="submit" class="btn btn-primary" name="addnewstokbahan">Submit</button>
        </div>
        </form>
        </div>
        </div>
